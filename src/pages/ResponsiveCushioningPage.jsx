  ...
  return (
    <div className="group cursor-pointer flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-[#707072] text-[15px] mb-3">{product.category}</p>
...
export default function ResponsiveCushioningPage() {
  const promos = [
    ...
    {
      text: "Apple Card: 6% Daily Cash with Apple Pay. Terms + limits apply.",
      link: "#",
    },
  ];
  ...
  const products = [
    {
      ...
      colorOptions: [
        "/assets/icons/icons_img_18.png",
        "/assets/icons/icons_img_19.png",
        "/assets/icons/icons_img_20.png",
        "/assets/icons/icons_img_21.png",
        "/assets/icons/icons_img_22.png",
        "/assets/icons/icons_img_23.png",
      ],
    },
    {
      id: 2,
      ...
      colorOptions: [
        "/assets/icons/icons_img_24.png",
        "/assets/icons/icons_img_25.png",
        "/assets/icons/icons_img_26.png",
      ],
    },
    {
      id: 3,
      ...
      colorOptions: [
        "/assets/icons/icons_img_27.png",
        "/assets/icons/icons_img_28.png",
        "/assets/icons/icons_img_29.png",
      ],
    },
    {
      id: 4,
      ...
      colorOptions: [
        "/assets/icons/icons_img_30.png",
        "/assets/icons/icons_img_31.png",
        "/assets/icons/icons_img_32.png",
        "/assets/icons/icons_img_33.png",
        "/assets/icons/icons_img_34.png",
        "/assets/icons/icons_img_35.png",
      ],
    },
    {
      id: 5,
      ...
      colorOptions: [
        "/assets/icons/icons_img_36.png",
        "/assets/icons/icons_img_37.png",
        "/assets/icons/icons_img_38.png",
        "/assets/icons/icons_img_39.png",
      ],
    },
    {
      id: 6,
      ...
      colorOptions: [
        "/assets/icons/icons_img_40.png",
        "/assets/icons/icons_img_41.png",
        "/assets/icons/icons_img_42.png",
        "/assets/icons/icons_img_43.png",
        "/assets/icons/icons_img_44.png",
        "/assets/icons/icons_img_45.png",
        "/assets/icons/icons_img_46.png",
      ],
    },
    {
      id: 7,
      ...
      colorOptions: [
        "/assets/icons/icons_img_47.png",
        "/assets/icons/icons_img_48.png",
      ],
    },
    {
      id: 8,
      ...
      colorOptions: [
        "/assets/icons/icons_img_49.png",
        "/assets/icons/icons_img_50.png",
        "/assets/icons/icons_img_51.png",
      ],
    },
    {
      id: 9,
      ...
      colorOptions: [
        "/assets/icons/icons_img_52.png",
        "/assets/icons/icons_img_53.png",
      ],
    },
    {
      id: 10,
      ...
      colorOptions: [
        "/assets/icons/icons_img_54.png",
        "/assets/icons/icons_img_55.png",
      ],
    },
    {
      id: 11,
      ...
      colorOptions: [
        "/assets/icons/icons_img_56.png",
        "/assets/icons/icons_img_57.png",
        "/assets/icons/icons_img_58.png",
        "/assets/icons/icons_img_59.png",
      ],
    },
    {
      id: 12,
      ...
      colorOptions: [
        "/assets/icons/icons_img_60.png",
        "/assets/icons/icons_img_61.png",
        "/assets/icons/icons_img_62.png",
        "/assets/icons/icons_img_63.png",
      ],
    },
  ];
    ...
    <div className="w-full flex flex-col min-h-screen bg-white font-sans text-black">
            ...
            >
              {promos.map((promo, index) => (
                ...
                >
                  <a
                    href={promo.link}
                    className="text-xs font-medium underline hover:text-zinc-600 transition-colors"
                  >
                    {promo.text}
                  </a>
                </div>
      ...
      <main className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-6">
        ...
        <div className="flex gap-10">
          {/* Sidebar */}
          <aside
            className="w-48 hidden md:block flex-shrink-0 pr-4 overflow-y-auto pill-scrollbar sticky top-24 self-start"
          ...
          >
            ...
            <div className="py-4 border-t border-zinc-200">
              ...
              <div
                className={`grid transition-all duration-300 ease-in-out ${openFilters.gender ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
              >
            ...
            <div className="py-4 border-t border-zinc-200">
              ...
              <div
                className={`grid transition-all duration-300 ease-in-out ${openFilters.kids ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
              >
                <div className="overflow-hidden">
                  <div className="space-y-2">
                    {["Boys", "Girls"].map((item) => (
            ...
            <div className="py-4 border-t border-zinc-200">
              ...
              <div
                className={`grid transition-all duration-300 ease-in-out ${openFilters.color ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
              >
                <div className="overflow-hidden">
                  <div className="grid grid-cols-3 gap-y-4 gap-x-2 pb-1">
                    {[
                      ...
                      >
                        <div
                          className={`w-7 h-7 rounded-full ${item.color} group-hover:ring-1 group-hover:ring-black group-hover:ring-offset-1 transition-all`}
                        ></div>
            ...
            <div className="py-4 border-t border-zinc-200">
              ...
              <div
                className={`grid transition-all duration-300 ease-in-out ${openFilters.brand ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
              >
                <div className="overflow-hidden">
                  <div className="space-y-2">
            ...
            <div className="py-4 border-t border-zinc-200">
              ...
              <div
                className={`grid transition-all duration-300 ease-in-out ${openFilters.sports ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
              >
                <div className="overflow-hidden">
                  <div className="space-y-2 pb-1">
                    {["Running", "Track & Field", "Outdoor", "Hiking"].map(
                      (item) => (
                        <label
                          key={item}
                          className="flex items-center gap-2 cursor-pointer"
